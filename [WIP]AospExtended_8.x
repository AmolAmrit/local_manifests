...
<manifest>
 <!--DeviceRepos-->
  <project path="device/xiaomi/kenzo" name="TheScarastic/device_xiaomi_kenzo" remote="github" revision="lineage-15.0" />
  <project path="device/xiaomi/msm8956-common" name="TheScarastic/android_device_xiaomi_msm8956-common" remote="github" revision="lineage-15.0" />
